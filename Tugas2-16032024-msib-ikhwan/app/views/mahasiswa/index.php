    ...
    <tbody>
        <?php foreach ($data['mhs'] as $mhs) : ?>
            <tr>
                <td><?= $mhs['nama'] ?></td>
                <td>
                    <a href="<?= BASEURL ?>/mahasiswa/hapus/<?= $mhs['id'] ?>" onclick="return confirm('Apakah anda yakin?')" class="badge badge-danger">Hapus</a>
                    <a href="<?= BASEURL ?>/mahasiswa/ubah/<?= $mhs['id'] ?>" data-toggle="modal" data-target="#formodal" class="badge badge-success tampilModalUbah" data-id="<?= $mhs['id']; ?>">Ubah</a>
